...
%      ?- caso1:resumen_caso(R).                  % verifica los conteos mínimos
%      ?- caso1:ranking_sospecha(R).              % revisa que el orden sea el que buscas
...
%      http://localhost:8080/investigacion/caso1
%
% =============================================================================
...
caso(caso1,
     'Caso 1 (pendiente)',
     'Sin redactar. El responsable de este caso debe llenar prolog/caso1.pl.',
     media).
...
% =============================================================================
%  REGLAS DE INFERENCIA PROPIAS DEL CASO 1  (mínimo 10)
% =============================================================================
